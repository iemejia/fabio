...
| Git integration | No | Full lifecycle: connect, status, commit, pull with per-item definition options, switch branch |
...
```bash
docker run --rm ghcr.io/iemejia/fabio:0.74.0 workspace list
```
