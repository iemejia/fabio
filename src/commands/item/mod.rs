...
pub enum ItemCommand {
    ...
    Create {
        ...
        /// Item definition JSON (the definition object or full envelope; inline or @file)
        #[arg(long)]
        definition: Option<String>,

        /// Item-type definition options as a JSON object (requires --definition; inline or @file)
    ...
    UpdateDefinition {
        ...
        /// Item-type definition options as a JSON object (inline or @file)
        #[arg(long)]
        options: Option<String>,
    },
    /// Delete an item
    ...
    BulkImportDefinitions {
        ...
        /// Per-item options keyed by logicalId as a JSON array (inline or @file)
        #[arg(long)]
