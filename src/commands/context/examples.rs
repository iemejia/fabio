...
const OUTPUT_EXAMPLES: &[(&str, &str)] = &[
    ...
    (
        "lakehouse/create-shortcut",
        include_str!("data/examples/lakehouse_create_shortcut.json"),
    ),
    (
    ...
    (
        ...
        include_str!("data/examples/environment_spark_settings.json"),
    ),
